...
var session = conf.session.replace(/LEONARD-MD;;;/g,"");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        ppgroup = 'https://files.catbox.moe/ps8cqh.jpg';
    }
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ Leonard Connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ Leonard Connection Established! ☺️");
                console.log("--");
                await (0, baileys_1.delay)(200);
                console.log("------");
                await (0, baileys_1.delay)(300);
                console.log("------------------/-----");
                console.log("Leonard is Online 🕸\n\n");
                //chargement des commandes 
                console.log("Loading Commands ...\n");
                fs.readdirSync(__dirname + "/LEONARD-BOT").forEach((fichier) => {
                    if (path.extname(fichier).toLowerCase() == (".js")) {
                        try {
                            require(__dirname + "/LEONARD-BOT/" + fichier);
...
║    *SUCCESSFULLY CONNECTED TO YOURE WHATSAPP* 
╚════════════════╝`;
